...
local function CreateWindow()
    local Window = WindUI:CreateWindow({
        ...
        Topbar = {
            Height = 44,
            ButtonsType = "Windows",  -- Menggunakan Windows style untuk button yang lebih visible
...
-- ═══════════════════════════════════════════════════════════════════════════
-- KEYBIND TOGGLE (Alternative untuk minimize issue)
-- ═══════════════════════════════════════════════════════════════════════════

local WindowVisible = true
local WindowObject = nil

local function SetupKeybindToggle(Window)
    WindowObject = Window
    
    -- Toggle dengan Right Control key
    UserInputService.InputBegan:Connect(function(input, gameProcessed)
        ...
        if input.KeyCode == Enum.KeyCode.RightControl then
            ...
            -- WindUI biasanya punya method untuk toggle visibility
...
local function Initialize()
    ...
    -- Setup keybind toggle (backup method)
    SetupKeybindToggle(Window)
    ...
    print("AFK Market v" .. Version .. " loaded successfully!")
    print("Press Right Control to toggle UI visibility")
end
